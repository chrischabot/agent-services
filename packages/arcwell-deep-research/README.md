...
- Broader difficult-document fixtures: hidden/merged XLSX sheets, dates, encrypted/scanned PDFs, rotated PDF tables, wrapped headers, and footnote-heavy statistical tables.
