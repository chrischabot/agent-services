...
pub struct WorkerRecurrenceAudit {
    ...
    pub latest_is_fresh: bool,
    pub observed_span_seconds: i64,
    pub max_gap_seconds: Option<i64>,
    pub current_segment_event_count: usize,
    pub current_segment_first_seen_at: Option<String>,
    pub current_segment_last_seen_at: Option<String>,
    pub current_segment_span_seconds: i64,
