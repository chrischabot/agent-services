// @generated by arcwell-memory/tools/gen_prompts_rs.py — DO NOT EDIT BY HAND.
// Source: arcwell_memory/arcwell_memory/configs/prompts.py (mem0ai/arcwell_memory v2.0.4).
// Regenerate with: python3 arcwell-memory/tools/gen_prompts_rs.py

pub const ADDITIVE_EXTRACTION_PROMPT: &str = r#"
...
pub const MEMORY_ANSWER_PROMPT: &str = r#"
